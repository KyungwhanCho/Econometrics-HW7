...
## The subgroup I chose, 22~55 years old female group who are fully employed

attach(acs2021)
use_varb <- (AGE >= 25) & (AGE <= 55) & (LABFORCE == 2) & (WKSWORK2 > 4) & (UHRSWORK >= 35) & (female == 1)
dat_use <- subset(acs2021,use_varb) # 
detach(acs2021)

## Null hypothesis: There is not a correlation between gender and proportion of people who are working in public work sector
